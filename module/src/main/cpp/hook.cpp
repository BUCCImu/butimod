...
const char* curList[] = { OBFUSCATE("GemsCurrency"), OBFUSCATE("Coins"), OBFUSCATE("ClanSilver"), OBFUSCATE("ClanLootBoxPoints"),  OBFUSCATE("Coupons"), OBFUSCATE("PixelPassCurrency"), OBFUSCATE("RouletteAdsCurrency"), OBFUSCATE("RouletteAdsSpin"), OBFUSCATE("PixelBucks"), OBFUSCATE("BattlePassCurrency"), OBFUSCATE("CurrencyCompetitionTier1"), OBFUSCATE("CurrencyCompetitionTier2"), OBFUSCATE("CurrencyCompetitionTier3"), OBFUSCATE("CurrencyCompetitionTier4"), OBFUSCATE("CurrencyCompetitionTier5"), OBFUSCATE("CurrencyCompetitionTier6"), OBFUSCATE("CurrencyCompetitionTier7"), OBFUSCATE("CurrencyCompetitionTier8"), OBFUSCATE("CurrencyCompetitionTier9"), OBFUSCATE("KeySmallChest"), OBFUSCATE("KeyEventChest"), OBFUSCATE("KeyBigChest"), OBFUSCATE("EventChestsSuperSpin"), OBFUSCATE("EventRouletteSuperSpin"), OBFUSCATE("Exp"), OBFUSCATE("TankKeys"), OBFUSCATE("PixelPassExp"), OBFUSCATE("clan_building_black_market"), OBFUSCATE("MainModeSlotToken"), OBFUSCATE("SmallChest"), OBFUSCATE("BigChest"), OBFUSCATE("EventChest"), OBFUSCATE("MegaChest"), OBFUSCATE("MerchOnBirthday2023"), OBFUSCATE("TemplateEventCurrency"), OBFUSCATE("MainModeSlot"), OBFUSCATE("AchievementTimeInGame"), OBFUSCATE("AdventNyCurrency"), OBFUSCATE("CraftCurrency") };
const char* prefabList[] = { OBFUSCATE("vehiclebattleroyale/hovercar/FreePlayHoverCar") };
bool maxLevel, cWear, uWear, gadgetUnlock, isLoadScenePressed, modKeys, tgod,
        ...
        doublejump, coindrop, isDiscordPressed, webLevel, blindness, kniferange, expbull, noChargeTime, spleef,
        shotbull, railbull, jumpdisable, slowdown, headmagnify, destroy, destroyL, destroyA, setMasterMe, recoilandspread, quickscope, speedup, speed,
        ...
        showItems, gadgetduration, isAddWeapons7, isAddWeapons8, isAddWeapons9, uncapFps, couponClicker, teamkill, noclip, pgod, pspeed, pdamage, prespawntime, addAllWepSkins,
        isAddWepPress, isAddWepPress2, addAllPets, addAllRoyale1, addAllRoyale2, addAllRoyale3, addAllRoyale4, playerScore, gbullets, flamethrower, pnoclip, reflections,
...
void *get_camera() {
    static const auto get_camera_injected = reinterpret_cast<uint64_t(__fastcall *)()>(g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x44D9924")));
...
monoString* CreateIl2cppString(const char* str)
{
    ...
    (monoString* (*)(const char* str, int *startIndex, int *length))(g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x478C688")));
    int* startIndex = 0;
...
int* getWearIndex(const char* str)
{
    ...
    (int* (*)(monoString* str))(g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x50E6638")));//search for ERROR!!!!!!! Нет серверной айдишки для одежды {0}
    return wearIndex(CreateIl2cppString(str));
}

void* webInstance()
{
    static void*(*webInstance)() = (void* (*)())(g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x5065594")));//Analyze LeprechauntManager.DropReward() and youll find it :)
    return webInstance();
}

void* weaponSkinInstance(const char* str)
{
    static void*(*skinInstance)() = (void* (*)())(g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x2A73EF8")));
    static void*(*weaponSkinInstance)(void*, int, monoString*) = (void* (*)(void*, int, monoString*))(g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x2A74110")));
    return weaponSkinInstance(skinInstance(), 1170, CreateIl2cppString(str));
}

void* graffitiInstance()
{
    static void*(*graffitiInstance)() = (void* (*)())(g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x20E9654")));
...
void Pointers() {
    addGraffiti = (void(*)(void*, monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x20EAF30")));
    addWeaponSkin = (void(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x1FE27FC")));
    addWeaponSkin2 = (void(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x1FE2514")));
    addSkin = (void(*)(void*, monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x508890C")));
  ...
  //  setString = (void(*)(monoString*, monoString*)) (void*) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x4541E00")));
   // getID = (monoString*(*)()) (monoString*) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x4363374")));
    setID = (void(*)(monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x4DFCAE8")));//search for AccountCreated

    setIDN = (void(*)(void*, monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x471E4FC")));//search for Texture2D texture2D = new Texture2D(64, 32, TextureFormat.RGBA32, num != 0L); in networkstarttable
   ...
   // buyButtonHandle = (void(*)(void*, monoString*)) (void*) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x38D2C88")));
    ...
    File$ReadAllLines = (monoArray<monoString*> *(*)(monoString*)) (monoArray<monoString*>*) (g_il2cppBaseMap.startAddress + string2Offset("0x348F4A4"));
    Application$persistentDataPath = (monoString*(*)()) (monoString*) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x4716EC8")));
    File$Exists = (bool(*)(monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x348E1B8")));
    provideRoyaleItem = (void(*)(monoString*, bool*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x35FCC3C")));//search for GlidersInfo.GLIDER_EQUIPPED_KEY and find the right method in that class
    providePet = (void(*)(monoString*, int*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x34F9844")));//search for [TEST] call StoreKitEventListener.CheckIfFirstTimePayment() and find the method in the class
    buyArmor = (void(*)(void* instance, int*, int*, monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x5059640")));//search Armor_Army_1 find the one from Progress and above it its the one
    provideGadget = (void(*) (monoString*, int*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x241E990")));//search Provid_eGadget gadget_Id == null
    targetFrameRate = (void(*)(int*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x4716FF4")));//search for SetTargetFrameRate in field/strings
    addWear = (void(*)(int*, monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x50E88A4"))); // search for WearScriptableObject_GENERATED
    //setState = (void(*)(int*)) (void*) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x49B20B4"))); doesnt work :)
    LoadLevel = (void(*)(monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x4AD5604")));//search LoadScene
    OpenURL = (void(*)(monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x4716F90")));//search OpenURL
    setSomething = (void(*) (void*, monoString*, int*, int*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x506E878")));//search up ClanLootBoxPoints and look for Progress
    SendChat = (void(*) (void*, monoString*, bool, monoString *)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x45ED650")));//search SendChat
    addWeapon = (void(*) (void*, monoString*, int*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x14D6AE0")));//search AddW_eaponToInv rec == null , tag =  {0}
    SetMasterClient = (bool(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset("0x4EF281C"));//search SetMasterClient in strings
    get_LocalPlayer = (void*(*)()) (g_il2cppBaseMap.startAddress + string2Offset("0x4EEB258"));//find the photonplayer class name and just search it until you find something similiar to the old version
    DestroyPlayerObjects = (void (*)(void *)) (g_il2cppBaseMap.startAddress + string2Offset("0x4EF2CD8"));//search DestroyPlayerObjects in strings
    DestroyAll = (void (*)(void *)) (g_il2cppBaseMap.startAddress + string2Offset("0x4EE8584"));
    PhotonNetwork_playerListothers = (monoArray<void **> *(*)()) (g_il2cppBaseMap.startAddress + string2Offset("0x4EEB568"));//same steps as localplayer, its the 2nd array, so below the first array method you see
    EnableXray = (void(*)(void*, bool)) (g_il2cppBaseMap.startAddress + string2Offset("0x45DF7A8"));//search "use_zoom"
    BuyStickerPack = (void(*)(int*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x3D9FBC8")));//look in StickersController, compare and find the right function
    JoinToRoomPhotonAfterCheck = (void(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x21912B4")));//not obfuscated just search
    JoinToRoomPhotonAfterCheckCustom = (void(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x3574188")));//not obfuscated just search
    // UNITY FUNC
    Component$get_gameObject = (void*(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x470C0AC")));
    Component$get_tag = (monoString*(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x470C584")));
    Component$get_transform = (void*(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x470C070")));
   // CharacterController$set_radius = (void(*)(void*, float)) (void*) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x457B544")));
    ...
    // OK ITS FINE NOW //
    GameObject$get_active = (bool(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x46F5B24")));
    GameObject$set_active = (void(*)(void*, bool)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x46F5B60")));
    Transform$get_forward = (Vector3 (*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x4718330")));
    string$StartsWith = (bool (*)(monoString*, monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x478644C")));
   ...
   //get_rotation = (void (*)(void*)) (void*) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x4410CB4")));
    ...
    EnableJetpack = (void (*)(void*, bool)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x45F3BF4")));//search for AddBonusAfterKillPlayerRPC, PhotonTargets.Others in player_move_c
 //   isDead = (bool (*)(void*)) (void*) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x143726C")));
    SetXrayShader = (void(*)(void*, bool)) (g_il2cppBaseMap.startAddress + string2Offset("0x4607FD0"));//in player_move_c search for .XRay, below is the methos
    getDeviceUniqueIdentifier = (monoString*(*)()) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x46EE054")));
...
void WeaponManager(void *obj) {
    if (obj != nullptr) {
        ...
        if (isAddWepPress2)
        {
            addWeapon(obj, CreateIl2cppString(wepList[selectedWeapon]), (int *) (62));
...
void WeaponSounds(void* obj){
    if(obj != nullptr){
        if(damage != NULL){
            *(float*)((uint64_t) obj + 0x3AC) = damage;//shotgunMaxDamageDistance
            *(float*)((uint64_t) obj + 0x3B0) = damage;//shotgunMinDamageCoef
            *(float*)((uint64_t) obj + 0x3B4) = damage;//shotgunOverDamageDistance
            *(float*)((uint64_t) obj + 0x3B8) = damage;//shotgunOverDamageCoef
        }
        ...
        if(firerate){
            *(int*)((uint64_t) obj + 0x610) = 999;
        }

        if(gundmg){
            *(bool*)((uint64_t) obj + 0x3BC) = true;//isSectorsAOE
            *(float*)((uint64_t) obj + 0x3C8) = 2.5;//sectorsAOEDamageMultiplierFront
            *(float*)((uint64_t) obj + 0x3CC) = 2.5;//sectorsAOEDamageMultiplierSide
            *(float*)((uint64_t) obj + 0x3D0) = 2.5;//sectorsAOEDamageMultiplierBack
            *(float*)((uint64_t) obj + 0x3D4) = 16;//sectorsAOERadiusSectorsAoE
        }

        if(invisible){
            *(bool*)((uint64_t) obj + 0x385) = true;//isInvisibleAfterRespawn
            *(float*)((uint64_t) obj + 0x388) = 9999999;//isInvisibleAfterRespawnTime
        }

        if(ignorereflect) {
            *(bool *) ((uint64_t) obj + 0x311) = false;//isDamageReflection
            *(bool *) ((uint64_t) obj + 0x312) = false;//isDamageAbsorption
        }
        ...
        if(catspam){
            *(bool*)((uint64_t) obj + 0x6A0) = true;//is3CatSpam
            *(bool*)((uint64_t) obj + 0x6A1) = true;//for3CatSpam
        }

        if(portalBull){
            *(bool*)((uint64_t) obj + 0x3D8) = true;//portalGun
            *(bool*)((uint64_t) obj + 0x3D9) = true;//isPortalExplosion
          //  *(int*)((uint64_t) obj + 0x3C0) = 1;//isPortalExplosion
        }

        if(charm){
            *(bool*)((uint64_t) obj + 0x274) = true;//isCharm
            *(float*)((uint64_t) obj + 0x278) = 99999;//charmTime
        }
        ...
        if(fte){
            *(bool*)((uint64_t) obj + 0x248) = true;//fireImmunity
            *(bool*)((uint64_t) obj + 0x249) = true;//bleedingImmunity
            *(bool*)((uint64_t) obj + 0x24A) = true;//toxicImmunity
        }

        if(snowstormbull){
            *(bool*)((uint64_t) obj + 0x2FC) = true;//snowStorm
            *(float*)((uint64_t) obj + 0x300) = 6;//snowStormBonusMultiplier
            if(snowstormbullval != NULL && !kniferange){
                *(float*)((uint64_t) obj + 0xDC) = snowstormbullval; // considerScopeValues
                *(float*)((uint64_t) obj + 0x658) = snowstormbullval; // range
            }
        }

        if(playerScore){
            *(bool*)((uint64_t) obj + 0x38C) = true;//isBuffPoints
            *(float*)((uint64_t) obj + 0x398) = 100000;//buffBonusPointsForKill
        }

        if(polymorph){
            *(bool*)((uint64_t) obj + 0x2EC) = true;//polymorpher
            *(float*)((uint64_t) obj + 0x2F0) = 9999999;//polymorphDuarationTime
            *(int*)((uint64_t) obj + 0x2F4) = 1;//polymorphType
            *(float*)((uint64_t) obj + 0x2F8) = 22340000;//polymorphMaxHealth
            harpoonBull = true;
        }

        if(enemymarker){
            *(bool*)((uint64_t) obj + 0x24B) = true;//enemyMarker
            *(bool*)((uint64_t) obj + 0x24D) = true;//enemyMarkerWhenShot
            *(bool*)((uint64_t) obj + 0x24C) = true;//enemyMarkerWhenAiming
            *(float*)((uint64_t) obj + 0x250) = 0;//enemyMarketChargeTime
        }

        if(electric){
            *(bool*)((uint64_t) obj + 0x42C) = true;//isElectricShock
            *(float*)((uint64_t) obj + 0x430) = 99999;//electricShockCoeff
            *(float*)((uint64_t) obj + 0x434) = 99999;//electricShockTime
        }


        *(bool*)((uint64_t) obj + 0x470) = false;//isDaterWeapon
        *(bool*)((uint64_t) obj + 0x5D0) = false;//campaignOnly

        if(gbullets){
            *(bool*)((uint64_t) obj + 0x475) = true;//isGrenadeWeapon
        }

        if(reflections){
            *(bool*)((uint64_t) obj + 0x311) = true;//isDamageReflection
            *(bool*)((uint64_t) obj + 0x312) = false;//isDamageAbsorption
            *(float*)((uint64_t) obj + 0x314) = -99999;//damageReflectionValue
        }

        if(flamethrower){
            *(bool*)((uint64_t) obj + 0x34C) = true;//flamethrower
        }

        if(blindness){
            *(bool*)((uint64_t) obj + 0x268) = true;//isBlindEffect
            *(float*)((uint64_t) obj + 0x270) = 99999;//isBlindEffectTime
        }

        if(crithit){
            *(float*)((uint64_t) obj + 0x480) = 9999;//criticalHitCoef
            *(float*)((uint64_t) obj + 0x47C) = 9999;//criticalHitChance
        }

        if(doublejump){
            *(bool*)((uint64_t) obj + 0x477) = true;//isDoubleJump
        }

        if(ammo){
            *(bool*)((uint64_t) obj + 0x469) = true;//isUnlimitedAmmo
            *(bool*)((uint64_t) obj + 0x1CB) = true;//useOneAmmoOnCHarge
        }

        if(coindrop){
            *(bool*)((uint64_t) obj + 0x330) = true;//isCoinDrop
            *(float*)((uint64_t) obj + 0x334) = MAXFLOAT;//coinDropChance
        }

        if(kniferange){
            *(bool*)((uint64_t) obj + 0x369) = true;//isFrostSword
            *(float*)((uint64_t) obj + 0x36C) = 5;//frostDamageMultiplier
            *(float*)((uint64_t) obj + 0x370) = 999999;//frostRadius
        }

        if(ammo){
            *(int*)((uint64_t) obj + 0x19C) = 99;//countShots
            *(int*)((uint64_t) obj + 0x60) = 99999;//InitialAmmo
            *(int*)((uint64_t) obj + 0x64) = 99999;//maxAmmo
        }
        ...
        if(kniferangesex && !kniferange){
            *(float*)((uint64_t) obj + 0xDC) = MAXFLOAT; // considerScopeValues
            *(float*)((uint64_t) obj + 0x658) = MAXFLOAT; // range
            *(float*)((uint64_t) obj + 0x664) = MAXFLOAT; //shootDistance
        }
        ...
        if(harpoonBull) {
            *(bool *) ((uint64_t) obj + 0x2B8) = true;//harpoon
            *(float *) ((uint64_t) obj + 0x2E0) = 99999;//harpoonMaxDistance
            *(float *) ((uint64_t) obj + 0x2D8) = 99999;//harpoonDecaySpeed
        }
        if(jumpdisable){
        ...
        if(speedup){
            *(bool*)((uint64_t) obj + 0x224) = true;//isSlowdown
            *(float*)((uint64_t) obj + 0x228) = MAXFLOAT;//slowdownCoeff
            *(float*)((uint64_t) obj + 0x22C) = 999999;//slowdownTime
        }

        if(slowdown){
            *(bool*)((uint64_t) obj + 0x224) = true;//isSlowdown
            *(float*)((uint64_t) obj + 0x228) = -9999999;//slowdownCoeff
            *(float*)((uint64_t) obj + 0x22C) = 999999;//slowdownTime
        }

        if(headmagnify){
            *(bool*)((uint64_t) obj + 0x260) = true;//isHeadMagnifier
            *(float*)((uint64_t) obj + 0x264) = 999999;//headMagnifierTime
        }
      ...
      if(spleef){
            *(bool*)((uint64_t) obj + 0x46C) = true;//isSpleef
        }
        ...
        if(god){
            *(bool*)((uint64_t) obj + 0x3EC) = true;//isArmorRegeneration
            *(float*)((uint64_t) obj + 0x3F0) = 9999;//armorRegenerationPercent
            *(float*)((uint64_t) obj + 0x3F4) = 0;//armorRegenerationTime
            ...
            *(bool*)((uint64_t) obj + 0x5A4) = true;//healingArea
            *(bool*)((uint64_t) obj + 0x5A5) = true;//healingHimSelf
            *(float*)((uint64_t) obj + 0x5A8) = 9999;//radiusHealing
        }

        if(mythic){
            *(int*)((uint64_t) obj + 0x65C) = 5;
            *(int*)((uint64_t) obj + 0x680) = 69420;
        }
        ...
        if(noChargeTime){
            *(float*)((uint64_t) obj + 0x1E4) = 0;//chargeTime
        }
...
{
    bool (*isEnemy)(void *player, void *enemy) = (bool(*)(void *, void *))(g_il2cppBaseMap.startAddress + string2Offset("0x189F97C")); // PlayerDamageable$$IsEnemyTo
...
{
    bool (*IsDead)(void *player) = (bool(*)(void *))(g_il2cppBaseMap.startAddress + string2Offset("0x189F984")); // PlayerDamageable$$IsDead
...
void(PlayerMoveC)(void* obj){
    if(obj != nullptr) {
        if (spamchat) {
            SendChat(obj, CreateIl2cppString("YouTube @buccimu subscribe"), false,CreateIl2cppString("0"));
        }
...
void PixelTime(void *obj) {
    if (obj != nullptr) {
        ...
        if (loadMenu) {
            LoadLevel(CreateIl2cppString(OBFUSCATE("AppCenter")));
            loadMenu = false;
        }
        if(portalLog){
...
void Hooks() {
        HOOK("0x473467C", networkStartTable, old_networkStartTable);
        HOOK("0x22B51D4", formatString, old_formatString);
        //HOOK("0x2135C9C", updateSkinButtons, old_updateSkinButtons);
        HOOK("0x3EF0920", PixelTime, old_PixelTime);
       // HOOK("0x38C1638", ShopNGUIController, old_ShopNGUIController);
        HOOK("0x18926F8", WeaponSounds, oldWeaponSounds);
        HOOK("0x14D28F8", WeaponManager, old_WeaponManager);
        HOOK("0x460C864", PlayerMoveC, oldPlayerMoveC); //1664
        HOOK("0x2192828", HandleJoinRoomFromEnterPasswordBtnClicked, old_HandleJoinRoomFromEnterPasswordBtnClicked);
        HOOK("0x3573F88", CustomHandleJoinRoomFromEnterPasswordBtnClicked, old_CustomHandleJoinRoomFromEnterPasswordBtnClicked);
        HOOK("0x1F607C4", Speed, oldSpeeds);
        HOOK("0x2747120", gadgetDuration, oldGadgetDuration);//search for gadget_combat_spinner and find the float via analyze
        HOOK("0x1FAFEE8", FirstPersonControllSharp, oldFirstPersonControllerSharp);
        //HOOK("0x458E231C", SendChatHooked, old_SendChatHooked);
        HOOK("0x43066F4", petSpeed, oldPetSpeeds);//PetInfo
        HOOK("0x4306484", petHealth, oldpetHealth);
        HOOK("0x43065BC", petAttack, oldpetAttack);
        //HOOK("0x1B04ED4", TeammateHealMultiplier, oldTeammateHealMultiplier);
}

void Patches() {
    PATCH_SWITCH("0x31FCB9C", "20008052C0035FD6", wepSkins6);

    PATCH_SWITCH("0x4732EFC", "C0035FD6", spoofMe3); // networkstarttable.start() -> used there
    PATCH_SWITCH("0x2A7983C", "00008052C0035FD6", modUp); //search OfferMiniIcons/module and look for the right method in the class
    PATCH_SWITCH("0x3DB9E80", "00008052C0035FD6", clanEnergy); // search Energy
    PATCH_SWITCH("0x3F15A0C", "00008052C0035FD6", bundles); // just analyze LobbyItemsBundle and compare it to the other one to find
    PATCH_SWITCH("0x3F15D1C", "00008052C0035FD6", bundles); // after you find the class ^^^^^^^^^^^^ search for LobbyItemBuff and get the set
    PATCH_SWITCH("0x2B40EC8", "20008052C0035FD6", bundles);
   // PATCH_SWITCH("0x38C5DAC", "20008052C0035FD6", shopnguitest);
    PATCH_SWITCH("0x3DBAC74", "00008052C0035FD6", clanparts); // just compare it
    PATCH_SWITCH("0x3DBA188", "00008052C0035FD6", clanparts); // just compare it 23.6.1
   // PATCH_SWITCH("0x310DB24", "20008052C0035FD6", wepSkins);
   // PATCH_SWITCH("0x3789DA0", "20008052C0035FD6", showWepSkins);
    PATCH_SWITCH("0x46384CC", "C0035FD6", god); // search int viewID and you'll find it (player_move_c)
    PATCH_SWITCH("0x3DFB088", "C0035FD6", god); // search for SkinName skinName = this.mySkinName; dont panic, itll be used alot, try to find the one which only takes SkinName and has the argument CategoryNames
    PATCH_SWITCH("0x4D4B724", "C0035FD6", god);//OnTriggerEnter
    PATCH_SWITCH("0x4D4AE94", "C0035FD6", god);//OnControllerColliderHit
    PATCH_SWITCH("0x1CA2C68", "A0F08FD2C0035FD6", maxLevel); // go to PlayerPanel.Update and the property inside the method should be lvl
  ...
  //  PATCH_SWITCH("0x305D3CC", "802580D2C0035FD6", cWear);
    PATCH_SWITCH("0x241C7BC", "00008052C0035FD6", gadgetUnlock);//search for GadgetsContent/GadgetsArmoryInfoPreview/empty below is the method
    PATCH_SWITCH("0x1F5DAA4", "603E8012C0035FD6", modKeys);//search for EventCurrency and try finding the right class or just use "C"
    PATCH_SWITCH("0x4E150A4", "C0035FD6", tgod);//all the minus live
    PATCH_SWITCH("0x4561440", "C0035FD6", tgod);
    PATCH_SWITCH("0x4566598", "C0035FD6", tgod);
    PATCH_SWITCH("0x4629AC4", "C0035FD6", removedrone);//player_move_c and DroneController droneController;
    PATCH_SWITCH("0x4629B7C", "C0035FD6", removedrone);//right below this ^^^
    PATCH_SWITCH("0x18934F0", "200080D2C0035FD6", crithit);//nexthitcritical in weaponsounds
    PATCH_SWITCH("0x1E9A8F0", "200080D2C0035FD6", couponClicker);//this requires abit of effort and luck, go to CollectButtonPressed the class is in the typeof handle then just try to match the bool to the one before by comparing it
    PATCH_SWITCH("0x4C84264", "00F0271EC0035FD6", reload);//mask_hitman_1_up1 in strings and the method with weaponsounds
    PATCH_SWITCH("0x2747120", "000080D2C0035FD6", gadgetcd);//search Action in player_move_c find the 2 fields with action exactly then above some bools should be a classname which is GADGET
    PATCH_SWITCH("0x4305D0C", "00008052C0035FD6", prespawntime);//search RespawnTime in petinfo
    //    PATCH_SWITCH("0x2F87D18", "00FA80D2C0035FD6", initParams); // do it 0x2F87D18 0x2F944C8 0x2F87D98 0x2F95CF8
    PATCH_SWITCH("0x2A75A3C", "80388152C0035FD6", collectibles); //search [{0}]{1}:{2}:{3} and just compare
    PATCH_SWITCH("0x1587BD8", "00008052C0035FD6", teamkill);//compare isTeamMode to 16.6.1  version goodluck (hint it should be the same as in 16.6.1)
    PATCH_SWITCH("0x1588F50", "00008052C0035FD6", teamkill);//look for Random in PlayerBotInstance, you'll find the bool at the end of the method
    ...
    PATCH("0x48D93B0", "C0035FD6");//antiban -  search DeveloperConsoleController.HandleBanUs and the method inside is the one
    PATCH("0x22B5D2C", "000080D2C0035FD6");//Swear filter search for fuck
    PATCH("0x34C1040", "200080D2C0035FD6");//ValidateNickName
    PATCH("0x34C1280", "200080D2C0035FD6");//ValidateNickNameNoAnalytics
    PATCH("0x2CAFCD4", "C0035FD6");//Search for DataSystem.DataValidation and the cctor inside the first class
    PATCH("0x467DCBC", "C0035FD6");//HandleShowAds
}

void DrawMenu(){
    static ImVec4 clear_color = ImVec4(0.0f, 0.0f, 0.0f, 1.00f);
    {
        ImGui::Begin(OBFUSCATE("zyCheats PG3D - Original (23.6.1) - BUCCI"));
        ...
        if (ImGui::BeginTabBar("Menu", tab_bar_flags)) {
            if (ImGui::BeginTabItem(OBFUSCATE("Account"))) {
                ...
                if (ImGui::CollapsingHeader(OBFUSCATE("Unlockables"))) {
                    ...
                    if (ImGui::CollapsingHeader(OBFUSCATE("Weapon Unlock")))
                    {
                        ...
                        if (ImGui::Button(OBFUSCATE("Add All Weapons 1051-1200"))) {
                            isAddWeapons8 = true;
                        }
                        if (ImGui::Button(OBFUSCATE("Add All Weapons 1201-LAST"))) {
                            isAddWeapons9 = true;
                        }
                        ImGui::ListBox(OBFUSCATE("Goofy Weapon"), &selectedWeapon, goofyWeps,IM_ARRAYSIZE(goofyWeps), 4);
                        if (ImGui::Button(OBFUSCATE("Add Unobtainable Weapon"))) {
                            isAddWepPress = true;
                        }
                        ImGui::ListBox(OBFUSCATE("Weapon"), &selectedWeapon, wepList,IM_ARRAYSIZE(wepList), 9);
                ...
                if (ImGui::CollapsingHeader(OBFUSCATE("Currency Mods"))) {
                    ImGui::SliderInt(OBFUSCATE("Amount"), &amountws, 0, 2700);
            ...
            if (ImGui::BeginTabItem(OBFUSCATE("Game"))) {
                ...
                ImGui::Checkbox(OBFUSCATE("Spleef All"), &spleef);
                if (ImGui::Button(OBFUSCATE("Crash Everyone"))) {
                    destroy = true;
                }
                ImGui::Checkbox(OBFUSCATE("Crash Everyone Loop"), &destroyL);
            ...
            if (ImGui::BeginTabItem(OBFUSCATE("Weapon"))) {
                ...
                ImGui::Checkbox(OBFUSCATE("No Charge Time"), &noChargeTime);
                ...
                if (ImGui::CollapsingHeader(OBFUSCATE("Effect Mods"))) {
                    ...
                    ImGui::Checkbox(OBFUSCATE("Force 3CatSpam"), &catspam);
                    ImGui::TextUnformatted(OBFUSCATE("no motion"));
                }
                ImGui::EndTabItem();
            }
            ...
            if (ImGui::BeginTabItem(OBFUSCATE("Misc"))) {
                ImGui::ListBox(OBFUSCATE("Select Scene"), &selectedScene, sceneList, IM_ARRAYSIZE(sceneList), 9);
